...
l = prod(genotypeFactor.card);
genotypeFactor.val = zeros(1, l);
...
for i=1:l,
   ...
   p1 = ass(2);
   p2 = ass(3);
   ap1 = genotypesToAlleles(p1,:);
   ap2 = genotypesToAlleles(p2,:);
   allelesc = genotypesToAlleles(c,:);
   a1c = allelesc(1);
   a2c = allelesc(2);
   ...
   genotypeFactor = SetValueOfAssignment(genotypeFactor,ass,a);
