...
for i=1:numPeople,
    p1 = pedigree.parents(i,1);
    p2 = pedigree.parents(i,2);
    if (p1==0)
...
for i=numPeople+1:2*numPeople,
    p1 = pedigree.parents(i-numPeople,1);
    p2 = pedigree.parents(i-numPeople,2);
    if (p1==0)
        factorList(i) = childCopyGivenFreqsFactor(alleleFreqs,i);
    else
        factorList(i) = childCopyGivenParentalsFactor(numAlleles, i, p2, p2 + numPeople);    
    endif
